...
<div class="jumbotron container-fluid">
    <div class="panel panel-default">
        <form action="/societyRunning/SocietyTagDetail.action" method="post" id="stform" name="stform">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 pull-right" style="margin: auto">
                        <div class="input-group pull-right" style="margin: auto">
                            <button class="btn btn-default" type="button" onclick="window.location.href='/societyRunning/SocietyTagList.action'">返回</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered table-hover table-responsive table-condensed">
                ...
                <c:forEach  items="${stlist}" var="society">
                    <tr>
