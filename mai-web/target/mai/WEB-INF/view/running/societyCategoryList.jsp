                ...
                <c:forEach  items="${sclist}" var="societyCategory">
                    <tr id="${societyCategory.categoryID}">
                        ...
                        <td>
                                    ...
                                    <%--<button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="auditmodal(this,'${actm.activitymemberID}',${actm.memberStatus},-1);">删除</button>--%>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
