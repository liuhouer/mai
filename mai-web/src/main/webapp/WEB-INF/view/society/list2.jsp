         ...
         <tr>
          ...
          <td>
            ...
            <c:if test="${s.status==2}"><!-- 审核通过 对应 【审核不通过 】-->
             ...
             <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="topDiv('${s.societyID}','-2');">下架</button>&nbsp;
             <c:if test="${s.isLog==1}">
             ...
             <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="topDiv('${s.societyID}','-1');">审核不通过</button>&nbsp;
              <c:if test="${s.isLog==1}">
             <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="topDiv('${s.societyID}','log2');">审核历史</button>&nbsp;
             </c:if>
             </c:if>
          </td>
        </tr>
