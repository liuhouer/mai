    ...
    <div class="btn-group" role="group" aria-label="..." style="padding-left: 20%;padding-right: 20px;">
        <p></p>
            <c:if test="${society.status =='0'}">
             <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="topDiv('${society.societyID}','1');">审核通过</button>
             <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="topDiv('${society.societyID}','-1');">审核不通过</button>
              <c:if test="${society.isLog==1}">
               <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal" onclick="topDiv('${society.societyID}','log');">审核历史</button>
              </c:if>
            </c:if>
