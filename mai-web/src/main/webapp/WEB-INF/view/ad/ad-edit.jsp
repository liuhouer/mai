...
<form method="post" action="/ad/edit.action" id="aform" name="aform" enctype="multipart/form-data">
<div class="jumbotron">

    <input type="hidden" name="id"  value="${model.advertisementID}"/>
    <input type="hidden" name="startTime"  value="${model.startTime}"/>
    <input type="hidden" name="endTime"  value="${model.endTime}"/>
    <input type="hidden" name="imageURL"  value="${model.imageURL}"/>
    <input type="hidden" name="isEnable"  value="${model.isEnable}"/>
