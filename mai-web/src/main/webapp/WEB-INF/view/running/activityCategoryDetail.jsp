...
<div class="jumbotron container-fluid">
    <div class="panel panel-default">
        <form action="/activityRunning/ActivityCategoryDetail.action" method="post" id="cform" name="cform">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 pull-right" style="margin: auto">
                        <div class="input-group pull-right" style="margin: auto">
                            <button class="btn btn-default" type="button" onclick="window.location.href='/activityRunning/ActivityCategoryList.action'">返回</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered table-hover table-responsive table-condensed">
                ...
                <c:forEach  items="${clist}" var="activity">
                    <tr>
